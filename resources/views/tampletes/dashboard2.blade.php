            ...
            <ul class="nav nav-pills d-flex flex-column mb-auto">
                ...
                <li class="nav-item ">
                    <a href="{{ route('timetable') }}" id="primary1"
                        class="nav-link text-light  d-flex justify-content-beetween align-items-center" aria-current="page">
                        <img src="public\img\calendar.png" alt="" width="16" height="16" class=" me-2">
                        <b>Расписание</b>
                    </a>
                </li>
                <li class="nav-item ">
                    <a href="#lesson"  id="primary1"class="nav-link text-light d-flex justify-content-beetween align-items-center"
                        aria-current="page">
                        <img src="public\img\calendar_event.png" alt="" width="16" height="16"
                            class=" me-2">
                        <b>Мои занятия</b>
                    </a>
                </li>
